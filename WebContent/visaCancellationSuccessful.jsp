		...
		<div class="container">
				...
				<div class="header">
					...
					<div id="nav">
						...
						<ul>
							...
							<li><a href="visaCancel.jsp" class="disabled">Cancel
									Visa</a>
							</li>
						</ul>
					</div>
			...
			<div class="content1">
				<div id="about"
					...
					<div class="cap">
						<h1
							style="text-align: center; color: #338080; font-size: 20px; text-align: center; float: absolute; margin: 0px 0px 0px 0px; float: absolute; text-shadow: 5px 5px 5px #9A9A9A;">Dear
							User Your request for Visa cancellation has been submitted
							successfully!!</h1>
							...
							<tr>
								<td height=50 width=400
									style="text-align: left; padding-left: 89px;"><h1
										style="text-align: center; color: green; font-size: 20px; text-align: center; float: absolute; margin: 0px 0px 0px 0px; float: absolute; text-shadow: 5px 5px 5px #9A9A9A;">Cancellation
										cost</h1></td>
								<td>
									<h1
