    ...
    %>
			<div class="content1">
				<div id="about"
					...
					<div class="cap">
						<h1
							style="text-align: center; color: #338080; font-size: 20px; text-align: center; float: absolute; margin: 0px 0px 0px 0px; float: absolute; text-shadow: 5px 5px 5px #9A9A9A;">Passport Application Successful!!</h1>
				...
				<tr>
								<td height=50 width=400
									style="text-align: left; padding-left: 89px;"><h1
										style="text-align: center; color: green; font-size: 20px; text-align: center; float: absolute; margin: 0px 0px 0px 0px; float: absolute; text-shadow: 5px 5px 5px #9A9A9A;">Passport Id </h1>
								</td>
								<td>
									<h1
										style="text-align: center; color: green; font-size: 15px; text-align: center; float: absolute; margin: 0px 0px 0px 0px; float: absolute;">
										 <%=passport.getPassportId()%></h1></td>
							</tr>
							<tr>
							<tr>
								<td height=50 width=400
									style="text-align: left; padding-left: 89px;"><h1
										style="text-align: center; color: green; font-size: 20px; text-align: center; float: absolute; margin: 0px 0px 0px 0px; float: absolute; text-shadow: 5px 5px 5px #9A9A9A;">Application Cost</h1>
								</td>
								<td>
									<h1
										style="text-align: center; color: green; font-size: 15px; text-align: center; float: absolute; margin: 0px 0px 0px 0px; float: absolute;">
										<%=passport.getPassportAmount()%></h1></td>
							</tr>
							<tr>
