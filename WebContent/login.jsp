...
<title>User Login : Passport Visa Management System</title>
<link href="CSS/style.css" rel="stylesheet" type="text/css" />
<link href="CSS/pulse-photo-news.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="js/jquery-1.3.1.min.js"></script>
<script type="text/javas
cript" src="js/pulse-photo-news.js"></script>
</head>
...
<div class="cap"><h1 style="text-align:center;color:#338080;font-size:20px;text-align:center;float:absolute;margin:0px 0px 0px 0px;float:absolute;text-shadow:5px 5px 5px #9A9A9A;">USER LOGIN </h1>
<hr>
...
<p style="text-align:center; color:red; " id="error">Invalid User ID/Password.&nbsp;</p>
<%}else{ %>
<p>&nbsp;</p>
<%} %>
...
<table width="70%" border="0" cellpadding="0" cellspacing="0" align="center">
 <tr>
    <td height=50 width=400 style="text-align:left;padding-left:89px;">User Id</td>
    <td>
      <input type="text" 
...
<tr><td></td></tr>
  <tr>
    <td height=50 width=400 style="text-align:left;padding-left:89px;">Password</td>
    <td>
      <input type="password" 
	        name="password"
	        id="password"
...
<tr>
  <td height=50 width=200 align="center"></td>
    <td>
    <input type="Submit" value="Login" style="width: 84px;
