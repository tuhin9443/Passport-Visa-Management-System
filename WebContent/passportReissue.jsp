...
">logout</a>
					<div id="nav">
						...
						<ul>
							...
							<li><a href="applyPassport.jsp">Apply Passport</a>
							</li>
							<li><a href="applyVisa.jsp">Apply Visa</a>
							</li>
							<li><a href="passportReissue.jsp" class="disabled">Reissue</a>
							</li>
							<li><a href="visaCancel.jsp">Cancel Visa</a>
							</li>
						</ul>
					</div>
				</div>
	...
	if (session1.getAttribute("LOGIN_ID") != null) {
		...
		requestDispatcher.forward(request, response);
			...
			<div class="content2">
				<div id="about"
					style="margin-left: 135px; background-color: #D6D6D6; text-align: left; overflow: auto; margin-top: 10px; border-radius: 10px; border: 2px double #286E87;">
					<form name="myForm" action="reissue" onsubmit="return validatePassportReissue()" method="post">
						<table width="70%" border="0" cellpadding="0" cellspacing="0"
							align="center">
							<tr>
								<td colspan="2" align="center" height=120><h1
										style="text-align: center; color: #338080; font-size: 40px; text-align: center; float: absolute; margin: 0px 0px 0px 155px; float: absolute; text-shadow: 5px 5px 5px #9A9A9A;">Re-Issue
										Passport</h1>
								</td>
							</tr>
							...
							<tr>
								<td height=50 width=400
									style="text-align: left; padding-left: 89px;">Reasons for
									Re-Issue<r> * </r>
								</td>
								<td><input type="radio" name="remarks" value="Lost" required/> Lost
									&nbsp <input type="radio" name="remarks" value="Damaged" />
									Damaged</td>
							</tr>
							<tr>
								<td height=50 width=200
									style="text-align: left; padding-left: 89px;">User-Id<r>
									* </r>
								</td>
								<td><input type="text" name="uid" maxlength="9" required/>
								</td>
							</tr>
							<tr>
								<td height=50 width=200
									style="text-align: left; padding-left: 89px;">Country<r>
									* </r>
								</td>
							...
							<tr>
								<td height=50 width=200
									style="text-align: left; padding-left: 89px;">State<r>
									* </r>
								</td>
								<td><select name="stateName" id="stateName"
									onchange="show()" required>
							...
							<tr>
								<td height=50 width=200
									style="text-align: left; padding-left: 89px;">City<r>
									* </r></td>
								<td>
									<div id="statediv">
							...
							<tr>
								<td height=50 width=200
									style="text-align: left; padding-left: 89px;">Pin<r> *
									</r>
								</td>
								<td><input type="digit" name="pin" id="pin" maxlength="10" required />
								</td>
							</tr>
							...
							<tr>
								<td height=50 width=200
									style="text-align: left; padding-left: 89px;">Type Of
									Service<r> * </r>
								</td>
								<td><input type="radio" name="servicetype" id="servicetype"
									value="Normal"> Normal &nbsp; <input type="radio"
									name="servicetype" id="servicetype" required value="Tatkal">
									Tatkal &nbsp; </td>
							</tr>
							...
							<tr>
								<td height=50 width=200
									style="text-align: left; padding-left: 89px;">Booklet Type<r>
									* </r>
								</td>
								<td><input type="radio" name="bookletType" id="bookletType"
									value="30P" /> 30 Pages &nbsp <input type="radio"
									name="bookletType" id="bookletType" value="60P" required/> 60 Pages</td>
							</tr>
							<tr>
								<td height=50 width=200
								...
								<td><input type="date" id="dateOfApplication"
									name="dateOfApplication" min="${minDate}" required></td>
							</tr>

							<tr>
								<td height=50 width=200 align="center"></td>
								<td><input type="hidden" value="reissuePassport"
									name="option" /> <input type="Submit" value="Register"
